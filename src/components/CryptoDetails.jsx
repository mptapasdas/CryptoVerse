...
const CryptoDetails = () => {
    ...
    const [timeperiod, setTimeperiod] = useState("7d"); //bug in line chart
    ...
    let twentyfour_hour_volume = cryptoDetails["24hVolume"]

    // const time = ["3h", "24h", "7d", "30d", "1y", "3m", "3y", "5y"]; //bug in viewing diff time period
    ...
    const stats = [
        ...
        { title: "Rank", value: cryptoDetails?.rank, icon: <NumberOutlined /> },
        {
            title: "24h Volume",
            value: `$ ${
                cryptoDetails["24hVolume"] && millify(twentyfour_hour_volume)
            }`,
